...
urlo = "https://api.darksky.net/forecast/7cefa5e6ef956bf1d81c5c2f827b7021/33.5897, 130.4207?units=si&lang=ja"
...
if pattern == "ptc":
    ...
    if b == "雨":
        ...
        message = "おはようございますっ！。上条春菜です！\n"+tyearo+"年"+tmontho+"月"+tdayo+"日の"+place+"の天気は"+b+"です。最高気温は"+high_temp_celsius_roundo+"度、最低気温は"+low_temp_celsius_roundo+"度です！\n朝晩が冷え込みますね！#ブルナポ朝の天気予報 #ブルナポ応援企画"
        print(message)
